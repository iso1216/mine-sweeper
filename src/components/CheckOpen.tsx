...
interface CheckOpenProps {
  boardOpen: number[];
  board: any[];
  num: number;
  handleChange: (event: React.MouseEvent<HTMLButtonElement> | KeyboardEvent, i: number) => void;
  height: number;
  point: boolean;
}

const CheckOpen: React.FC<CheckOpenProps> = ({boardOpen, board, num, handleChange, height, point}) => {
